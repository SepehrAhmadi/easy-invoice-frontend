<template>
    ...
    >
        <div class="tw:px-5! tw:py-4!">
            ...
            <!-- avatar section -->
            <div
                class="tw:flex tw:justify-between tw:items-cneter tw:mt-4! tw:gap-2"
            >
                <div
                ...
                <div class="tw:mt-2! tw:flex tw:flex-col tw:gap-1">
                    <div
                        class="tw:flex tw:justify-start tw:items-start tw:gap-1"
                    >
                        <icon-circle
            ...
            <!-- username -->
            <div
                class="tw:flex tw:justify-start tw:items-cneter tw:mt-4! tw:gap-2"
            >
                <v-text-field
            ...
            <div
                class="tw:flex tw:justify-start tw:items-center tw:mt-8! tw:gap-1"
            >
                <icon-lock
                    class="tw:text-[23px] tw:text-gray-600! tw:dark:text-gray-300!"
                />
                <div
                    class="tw:text-[15px] tw:text-gray-700! tw:dark:text-gray-300!"
                >
