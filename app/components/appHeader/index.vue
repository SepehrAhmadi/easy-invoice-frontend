<template>
  <div class="header-sidebar">
    ...
    <v-navigation-drawer v-model="drawer" :rail="rail" width="250" rail-width="70" app
      :temporary="$vuetify.display.smAndDown">
      <div class="tw:flex tw:flex-col tw:justify-start tw:items-start tw:gap-2 tw:m-4.25! tw:mt-1!">
        <div v-for="(item, index) in menuItems" :key="item.id" class="tw:w-full">
          <!-- main items -->
          <div
            ...
            <div class="tw:flex tw:justify-center tw:items-center">
              <icon-arrow-down v-if="item.subItems && !rail"
            ...
            <icon-circle class="tw:hidden tw:text-[6px] tw:text-gray-600! tw:dark:text-gray-300! tw:absolute tw:top-5"
              :class="{
                'tw:md:block!':
          ...
          <transition name="submenu">
            <div v-show="item.subItems && openGroup === item.id && !rail" class="tw:flex tw:flex-col tw:gap-1">
