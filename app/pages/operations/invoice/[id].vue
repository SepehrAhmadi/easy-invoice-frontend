            ...
            >
                ...
                <v-col cols="12" md="9" xl="6">
                    ...
                    >
                        ...
                        <transition
                            name="expand-btn"
                            @after-leave="onExpandLeave"
                        >
                            <v-row
                                v-if="showInvoiceFormExpand"
                                class="tw:px-0!"
                            >
                                <v-col
                                    cols="12"
                                    md="2"
                                    class="tw:hidden! tw:md:block! tw:3xl:hidden!"
                                ></v-col>
                                <v-col
                                    cols="12"
                                    md="4"
                                ...
                                >
                                    <div class="tw:relative!">
                                        ...
                                        >
                                            {{ langStore.label.form.date }}
                                            <span
                                                class="tw:text-red-400 tw:text-[10px]"
                                            >
                                                ({{
                                ...
                                >
                                    ...
                                    >
                                        <template #label>
                                            ...
                                            <span
                                                class="tw:text-red-200 tw:text-[10px]"
                                            >
                                                ({{
                                                    langStore.label.caption
                                                        .required
                    ...
                    <v-row class="tw:items-center tw:mt-1!">
                        <v-col cols="12" md="6" lg="3" xl="2">
                            ...
                            >
                                <v-radio
                                    :value="false"
                                    class="tw:text-gray-300! tw:ms-5!"
                                >
                                    <template #label>
                                        <div
                                            class="tw:flex tw:justify-center tw:items-center tw:gap-1"
                                        >
                                            <div
                                                class="tw:text-gray-300! tw:text-[12px]"
                                            >
                                                {{
                        ...
                        <v-col cols="12" md="6" lg="3" xl="2">
                            ...
                            >
                                <template #label>
                                    ...
                                    <span
                                        class="tw:text-red-300! tw:text-[10px]"
                                    >
                                        ({{ langStore.label.caption.required }})
                                    </span>
                                </template>
                        ...
                        <v-col cols="12" md="6" lg="3" xl="2">
                            ...
                            >
                                ...
                                <template #append-inner>
                                    <div
                                        class="tw:text-[13px] tw:text-gray-400"
                                    >
...
const signlePriceDisplay = computed({
    get() {
        const val = invoiceItemForm.value.singlePrice;
        if (val === null) return "";
        return Number(val).toLocaleString("en-US");
    },
    set(input) {
        const raw = input.replace(/[^\d]/g, "");
        invoiceItemForm.value.singlePrice = raw === "" ? null : Number(raw);
        calTotalPrice();
    },
});
const totalPriceDisplay = computed({
    get() {
        const val = invoiceItemForm.value.totalPrice;
        if (val === null) return "";
        return Number(val).toLocaleString("en-US");
    },
    set(input) {
        const raw = input.replace(/[^\d]/g, "");
        invoiceItemForm.value.totalPrice = raw === "" ? null : Number(raw);
        calTotalPrice();
    },
});
