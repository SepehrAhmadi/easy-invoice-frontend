  ...
  <div>
    <v-container class="tw:md:pe-0! tw:md:py-0!">
      ...
      >
        ...
        <v-col cols="12" md="2" xl="3" class="tw:hidden tw:3xl:block"></v-col>
          ...
          >
            ...
            <transition name="expand-btn" @after-leave="onExpandLeave">
              <v-row v-if="showInvoiceFormExpand" class="tw:px-0!">
                <v-col cols="12" md="2" class="tw:hidden! tw:md:block! tw:3xl:hidden!"></v-col>
                <v-col cols="12" md="4" xl="5" class="tw:md:px-1.5!">
