<template>
    <div class="tw:flex tw:flex-col tw:min-h-full">
        <v-container fluid class="tw:md:pe-0! tw:md:py-0!">
            ...
            >
                <v-col cols="12">
                    ...
                    >
                        <div>
                            ...
                            >
                                ...
                                <transition name="fade">
                                    <div
                                        class="tw-text-color-reverse tw:mx-1!"
                                        v-if="companyName"
                                    >
                                        |
                                    </div>
                        ...
                        <transition name="fade">
                            <v-btn
                                v-if="showInvoiceItemsTabel"
                                @click="loadInvoices(companyId, 'prev')"
                                rounded="pill"
            ...
            <v-row
                class="tw:bg-white! tw:dark:bg-primary-dark! tw:rounded-b-4xl! tw:p-6!"
            >
                <v-col
                    cols="12"
                    md="4"
                ...
                >
                    ...
                    >
                        ...
                        <div
                            class="tw:flex tw:flex-col tw:justify-center! tw:gap-2"
                        >
                            <!-- paid invoices -->
                            <div
                            ...
                            >
                                <div
                                    class="tw:flex tw:justiyf-start tw:items-center tw:gap-1"
                                >
                                    <div>
                                        <icon-check-double
                                            class="tw-text-color-reverse tw:text-[20px]"
                                        />
                                    </div>
                                    <div
                                        class="tw:flex tw-text-color-reverse tw:text-[13px]/5"
                                    >
                                        {{ langStore.label.table.paid }} :
                                    </div>
                                    <div
                                        v-if="report?.totalPaidPrice > 0"
                                        class="tw:flex tw:justify-center tw:items-center tw-text-color-reverse tw:text-[14px] tw:gap-1"
                                    >
                                        {{
                                            report?.totalPaidPrice <= 0
                                                ? "--"
                                                : separateNumber(
                                                      report?.totalPaidPrice,
                                                  )
                                        }}
                                ...
                                >
                                    <div
                                        v-if="report?.paidInvoicesCount > 0"
                                        class="tw:flex tw:justify-center tw:items-center tw-text-color-reverse tw:text-[14px] tw:gap-1"
                                    >
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <icon-hourglass
                                            class="tw-text-color-reverse tw:text-[18px]"
                                        />
                                    </div>
                                    <div
                                        class="tw:flex tw-text-color-reverse tw:text-[13px]/5"
                                    >
                                        {{
                                            langStore.label.table
                                                .awaitingPayment
                                        }}
                                        :
                                    </div>
                                    <div
                                        v-if="report?.totalAwaitingPrice > 0"
                                        class="tw:flex tw:justify-center tw:items-center tw-text-color-reverse tw:text-[14px] tw:gap-1"
                                    >
                                        {{
                                            report?.totalAwaitingPrice <= 0
                                                ? "--"
                                                : separateNumber(
                                                      report?.totalAwaitingPrice,
                                                  )
                                        }}
                                        <div class="tw:text-[13px]">
                                            {{ langStore.label.caption.rial }}
                                ...
                                >
                                    <div
                                        v-if="report?.awaitingInvoicesCount > 0"
                                        class="tw:flex tw:justify-center tw:items-center tw-text-color-reverse tw:text-[14px] tw:gap-1"
                                    >
                ...
                >
                    ...
                    >
                        <SwiperSlide
                            v-for="item in report?.companies as any[]"
                            class="tw:h-auto!"
                        >
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            />
                                            <div
                                                class="tw-text-color-lighter tw:text-[13px]"
                                            >
                                                {{
                                                    item.companyType ==
                                                    CompanyType.legalEntity
                                        ...
                                        <div
                                            class="tw-text-color tw:text-[20px]! tw:font-semibold tw:mt-1! tw:2xl:mt-1!"
                                        >
                                            {{ item.companyName }}
                                        </div>
                                        <!-- paid invoces -->
                                        <div
                                            class="tw:flex tw:justify-between tw:items-center tw:gap-1 tw:mt-3!"
                                        >
                                            <div
                                            ...
                                            >
                                                ...
                                                <div
                                                    v-else
                                                    class="tw-text-color tw:text-[14px] tw:ms-1!"
                                                >
                                                    ----
                                                </div>
                                            </div>
                                            ...
                                            >
                                                ...
                                                <div
                                                    v-else
                                                    class="tw-text-color tw:text-[14px]"
                                                >
                                                    ----
                                                </div>
                                            </div>
                                        ...
                                        <!-- awaiting invoices -->
                                        <div
                                            class="tw:flex tw:justify-between tw:items-center tw:gap-1 tw:mt-2! tw:2xl:mt-2!"
                                        >
                                            <div
                                                class="tw:flex tw:justify-start tw:items-center"
                                            >
                                    ...
                                    <!-- view detail -->
                                    <div
                                        @click="loadInvoices(item, 'new')"
                                        class="tw:flex tw:justify-end tw:items-center tw:gap-2 tw:lg:mt-3!"
                                    >
                                        <v-btn
                                            size=" x-small"
                                            variant="outlined"
                ...
                <v-col cols="12" class="tw:p-0! tw:pt-5!">
                    <v-card
                        v-if="
                            showInvoicesTabel && invoices && invoices.length > 0
                        "
                    ...
                    >
                        <v-data-table-virtual
                            ...
                            hide-default-footer
                            height="430"
                            class="tw:bg-primary-light! tw:dark:bg-background-dark! tw:rounded-4xl!"
                        >
                                    ...
                                    <td class="tw:w-auto!">
                                        <div class="tw:flex tw:justify-center">
                                            ...
                                            >
                                                ...
                                                />
                                                <div
                                                    class="tw-text-color-lighter tw:text-[12px]"
                                                >
                                                    {{
                                                        item.companyType ==
                                                        CompanyType.legalEntity
                    ...
                    <v-card
                        v-if="showInvoiceItemsTabel && invoiceItems.length > 0"
                        class="tw:rounded-4xl! tw:shadow-none!"
                    >
                        <v-data-table-virtual
