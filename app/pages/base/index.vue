  ...
  <div class="tw:flex tw:flex-col tw:min-h-full">
    ...
    <v-container fluid class="tw:md:pe-0! tw:md:py-0!">
      <v-row class="tw:flex tw:justify-center tw:itesm-center">
        <v-col cols="12" sm="4" md="3"
          ...
          <v-btn @click="openCompanyModal('add')" color="white" class="tw:rounded-full! tw:mt-3! tw:h-10!">
              ...
              <div class="tw:h-auto tw:flex">
                <div
                  ...
                  <div>
                    ...
                    <div class="tw-text-color tw:text-[20px]! tw:font-semibold tw:mt-1! tw:2xl:mt-2!">
                      {{ item.name }}
                    </div>
                    <div class="tw:flex tw:justify-start tw:items-start tw:gap-1 tw:mt-2!">
                      <span>
                        <icon-location class="tw-text-color-lighter tw:text-[20px]" />
                      </span>
                      <span class="tw:flex tw-text-color-lighter tw:text-[13px]/5">
                        {{ langStore.label.table.address }} : {{ item.address }}
                      </span>
                    </div>
                    <div class="tw:flex tw:justify-start tw:items-center tw:gap-1 tw:mt-2! tw:2xl:mt-2!">
                  ...
                  <div class="tw:flex tw:justify-end tw:items-center tw:gap-2 tw:mt-4!">
                    <v-btn @click="openCompanyModal('edit', item.id)" size=" x-small" variant="outlined" rounded="pill"
                      class="tw:px-0! tw:py-0.75! tw:2xl:py-0.75! tw:w-23">
                      <icon-edit class="tw-text-color-lighter tw:text-[15px] tw:me-2!" />
                      <div class="tw-text-color-lighter tw:text-[11px] tw:3xl:text-[12px]">
                        {{ langStore.label.button.edit }}
                      </div>
                    </v-btn>
                    <v-btn @click="openDeleteModal('comapny', item.id)" size=" x-small" variant="outlined"
                      rounded="pill" class="tw:px-0! tw:py-0.75! tw:2xl:py-0.75! tw:w-23">
                      <icon-trash class="tw-text-color-lighter tw:text-[17px] tw:me-2!" />
                      <div class="tw-text-color-lighter tw:text-[11px] tw:3xl:text-[12px]">
    ...
    <v-container fluid class="tw:md:pe-0! tw:my-5!">
      <v-row class="tw:h-full!">
        <!-- brands -->
        <v-col cols="12" lg="12" xl="6" class="tw:w-full! tw:lg:px-0! tw:2xl:ps-0! tw:2xl:pe-3! tw:flex">
          <div class="tw:bg-white tw:dark:bg-primary-dark tw:rounded-4xl tw:overflow-hidden tw:grow!">
            <!-- section header -->
            <div class="tw:bg-primary-dark tw:border-b tw:border-gray-300 tw:dark:bg-primary-dark tw:p-4! tw:2xl:px-6!">
              <div
                ...
                <div>
                  <transition name="fade" @after-leave="onBrandFadeLeave">
                    <v-btn v-if="!showBrandFormExpand && !isBrandAnimating" @click="openBrandForm('add')" color="white"
                      rounded="pill" class="tw:h-10!">
                      <div class="tw:flex tw:justify-center tw:items-center tw:gap-2">
                  ...
                  <transition name="expand-btn" @after-leave="onBrandExpandLeave">
                    <div v-if="showBrandFormExpand" class="tw:flex tw:justify-start tw:items-center tw:gap-3">
                      <v-text-field v-model="brandForm.name" type="text" variant="outlined" density="compact"
                        hide-details class="tw:text-[14px]! tw:w-50! tw:text-white!" rounded="pill"
            ...
            <div
              ...
              <div v-for="(item, index) in brands" :key="item.id"
                ...
                <div class="tw:flex tw:justify-start tw:items-center tw:gap-1">
                  <v-tooltip location="top">
                    <template #activator="{ props }">
                      <v-btn @click="openBrandForm('edit', item.id)" v-bind="props" size="x-small" variant="text"
                        rounded="pill" class="tw:w-8! tw:h-8! tw:px-0!">
                        <icon-edit class="tw-text-color-lighter tw:text-[20px]" />
                      </v-btn>
                    </template>
                  ...
                  <v-tooltip location="top">
                    <template #activator="{ props }">
                      <v-btn @click="openDeleteModal('brand', item.id)" v-bind="props" size="x-small" variant="text"
                        rounded="pill" class="tw:w-8! tw:h-8! tw:px-0!">
        ...
        <!-- category -->
        <v-col cols="12" lg="12" xl="6" class="tw:w-full! tw:lg:px-0! tw:2xl:pe-0! tw:2xl:ps-3! tw:flex">
          <div class="tw:bg-white tw:dark:bg-primary-dark tw:rounded-4xl tw:overflow-hidden tw:grow!">
            <!-- section header -->
            <div class="tw:bg-primary-dark tw:border-b tw:border-gray-300 tw:dark:bg-primary-dark tw:p-4! tw:2xl:px-6!">
              <div
                ...
                <div>
                  <transition name="fade" @after-leave="onCategoryFadeLeave">
                    <v-btn v-if="!showCategoryFormExpand && !isCategoryAnimating" @click="openCategoryForm('add')"
                      color="white" rounded="pill" class="tw:h-10!">
                      <div class="tw:flex tw:justify-center tw:items-center tw:gap-2">
                        <icon-plus-circle class="tw:text-[18px]" />
                        <div class="tw:text-[13px] tw:3xl:text-[15px]">
                  ...
                  <transition name="expand-btn" @after-leave="onCategoryExpandLeave">
                    <div v-if="showCategoryFormExpand" class="tw:flex tw:justify-start tw:items-center tw:gap-3">
                      <v-text-field v-model="categoryForm.name" type="text" variant="outlined" density="compact"
                        hide-details class="tw:text-[14px]! tw:w-50! tw:text-white!" rounded="pill"
                      ...
                      <v-btn @click="submitCategory" color="white"
                        class="tw:rounded-full! tw:w-9.5! tw:h-9.5! tw:min-w-0! tw:p-0!" icon>
                        <icon-check class="tw:text-[23px] tw:3xl:text-[25px]" />
                      </v-btn>
                      <v-btn @click="toggleCategory('close')" color="white"
                        class="tw:rounded-full! tw:w-9.5! tw:h-9.5! tw:min-w-0! tw:p-0!" icon>
                        <icon-close class="tw:text-[23px] tw:3xl:text-[25px]" />
                      </v-btn>
                    </div>
            ...
            <div
              ...
              <div v-for="(item, index) in categories" :key="item.id"
                ...
                <div class="tw:flex tw:justify-start tw:items-center tw:gap-1">
                  <v-tooltip location="top">
                    <template #activator="{ props }">
                      <v-btn @click="openCategoryForm('edit', item.id)" v-bind="props" size="x-small" variant="text"
                        rounded="pill" class="tw:w-8! tw:h-8! tw:px-0!">
                        <icon-edit class="tw-text-color-lighter tw:text-[20px]" />
                      </v-btn>
                    </template>
                  ...
                  <v-tooltip location="top">
                    <template #activator="{ props }">
                      <v-btn @click="openDeleteModal('category', item.id)" v-bind="props" size="x-small" variant="text"
                        rounded="pill" class="tw:w-8! tw:h-8! tw:px-0!">
                        <icon-trash class="tw-text-color-lighter tw:text-[23px]" />
                      </v-btn>
                    </template>
        ...
        <v-col cols="12" class="tw:w-full! tw:px-0! tw:2xl:px-0! tw:flex">
          <div class="w:overflow-hidden tw:bg-white tw:dark:bg-primary-dark tw:rounded-4xl tw:grow!">
            <!-- sections header -->
            <div
              ...
              <div
                ...
                <div class="tw:flex tw:justify-start tw:items-center tw:gap-4 tw:w-full tw:lg:w-auto">
                  <v-btn @click="openProductModal('add')" color="white" rounded="pill" class="tw:h-10!">
                    <div class="tw:flex tw:justify-center tw:items-center tw:gap-2">
                      <icon-plus-circle class="tw:text-[18px]" />
                      <div class="tw:text-[13px] tw:3xl:text-[15px]">
                  ...
                  <v-text-field v-model="searchProduct" type="text" variant="solo" density="compact" hide-details
                    class="tw:text-[14px]! tw:lg:w-90! tw:flex-1" bg-color="white" rounded="pill"
            ...
            <div
              ...
              <div v-for="item in filteredProducts" :key="item.id"
                ...
                <div class="tw:w-full! tw:flex tw:justify-start tw:items-center tw:gap-2">
                  <!-- icon type -->
                  <div
                    class="tw:bg-primary-dark tw:rounded-full tw:w-20 tw:h-16 tw:flex tw:items-center tw:justify-center">
                    <img :src="getPackagingIcon(item.packagingType)" class="tw:w-12 tw:h-12" />
                  </div>
                  ...
                  <div class="tw:w-full! tw:flex tw:flex-col tw:gap-1">
                    ...
                    <!-- brand -->
                    <div class="tw:flex tw:justify-start tw:items-center tw:gap-1">
                      <icon-checkmark class="tw-text-color-lighter tw:text-[18px]" />
                      <span class="tw:flex tw-text-color-lighter tw:text-[12px]/5 tw:3xl:text-[13px]/5">
                    ...
                    <div
                      ...
                      <div class="tw:flex tw:justify-start tw:items-center tw:gap-1">
                        <icon-box class="tw-text-color-lighter tw:text-[18px]" />
                        <span class="tw:flex tw-text-color-lighter tw:text-[12px]/5 tw:3xl:text-[13px]/5">
                      ...
                      <div class="tw:flex tw:justify-start tw:items-center tw:gap-1">
                        <icon-pie-chart class="tw-text-color-lighter tw:text-[18px]" />
                        <span class="tw:flex tw-text-color-lighter tw:text-[12px]/5 tw:3xl:text-[13px]/5">
                ...
                <!-- actiosn -->
                <div class="tw:flex tw:justify-end tw:items-center tw:gap-2 tw:mt-3!">
                  <v-btn @click="openProductModal('edit', item.id)" size=" x-small" variant="outlined" rounded="pill"
                    class="tw:px-0! tw:py-0.75! tw:2xl:py-0.75! tw:w-23">
                    <icon-edit class="tw-text-color-lighter tw:text-[15px] tw:me-2!" />
                    <div class="tw-text-color-lighter tw:text-[11px] tw:3xl:text-[12px]">
                      {{ langStore.label.button.edit }}
                  ...
                  <v-btn @click="openDeleteModal('product', item.id)" size=" x-small" variant="outlined" rounded="pill"
                    class="tw:px-0! tw:py-0.75! tw:2xl:py-0.75! tw:w-23">
                    <icon-trash class="tw-text-color-lighter tw:text-[17px] tw:me-2!" />
                    <div class="tw-text-color-lighter tw:text-[11px] tw:3xl:text-[12px]">
                      {{ langStore.label.button.delete }}
    ...
    <v-dialog v-model="campanyModal" max-width="750" class="blur-dialog">
      <v-card class="tw:rounded-2xl!">
        <v-card-title class="tw:border-b-2 pa-0" :class="{
          ...
          <div class="tw:absolute tw:top-3 tw:end-3">
            <v-tooltip location="top">
              <template #activator="{ props }">
                <icon-close @click="close" class="tw-text-color-lighter tw:text-[17px] tw:cursor-pointer"
                  v-bind="props" />
              </template>
              <span class="tw:text-xs tw:p-2">{{
        ...
        <v-card-text class="tw:p-3! tw:mt-2!">
          <v-row class="tw:p-1!">
            <v-col cols="12" md="6" lg="4" class="tw:flex tw:justify-center tw:items-center tw:w-full!">
              <v-radio-group v-model="companyForm.type" inline density="compact" hide-details
                class="tw:flex! tw:justify-center! tw:items-center! tw:gap-3! tw:w-full!">
                <v-radio :value="CompanyType.legalEntity" class="tw-text-color-lighter tw:ms-5!">
                  <template #label>
                ...
                <v-radio :value="CompanyType.individual" class="tw-text-color-lighter tw:ms-5!">
                  <template #label>
                    <div class="tw:flex tw:justify-center tw:items-center tw:gap-1">
            ...
            <v-col cols="12" md="6" lg="4">
              <v-text-field v-model="companyForm.name" type="text" variant="outlined" density="compact" hide-details
                class="tw:text-[14px]!" rounded="lg">
                <template #label>
                  <span class="tw:text-[12px]">
                    {{ langStore.label.form.name }}
                  </span>
            ...
            <v-col cols="12" md="6" lg="4">
              <v-text-field v-model="companyForm.phone" type="number" variant="outlined" density="compact" hide-details
                hide-spin-buttons class="tw:text-[14px]! centred-input" rounded="lg">
                <template #label>
                  <span class="tw:text-[12px]">
            ...
            <v-col cols="12">
              <v-text-field v-model="companyForm.address" variant="outlined" density="compact" hide-details
                hide-spin-buttons class="tw:text-[14px]!" rounded="lg" @keyup.enter="submitCompany">
                <template #label>
                  <span class="tw:text-[12px]">
        ...
        <v-card-actions class="tw:px-4!">
          <div class="tw:w-full tw:flex tw:justify-end tw:items-center tw:gap-1">
            ...
            <v-btn @click="submitCompany" size="" rounded="lg" class="tw:border! tw:px-0! tw:py-1! tw:w-30" :class="{
    ...
    <v-dialog v-model="productModal" max-width="350" class="blur-dialog">
      <v-card class="tw:rounded-2xl!">
        ...
        <v-card-text class="tw:p-3! tw:mt-2!">
          <v-row class="">
            <v-col cols="12">
              <v-text-field v-model="productForm.name" type="text" variant="outlined" density="compact" hide-details
                class="tw:text-[14px]" rounded="lg">
                <template #label>
                  <span class="tw:text-[12px]">
                    {{ langStore.label.form.name }}
            ...
            <v-col cols="12">
              <v-autocomplete v-model="productForm.brandId" :items="dropdownStore.brandsOptions" item-title="text"
                item-value="value" variant="outlined" density="compact" hide-details class="tw:text-[14px]"
                rounded="lg">
                <template #label>
                  <span class="tw:text-[12px]">
            ...
            <v-col cols="12">
              <v-autocomplete v-model="productForm.packagingId" :items="dropdownStore.packagingsOptions"
            ...
            <v-col cols="12">
              <v-autocomplete v-model="productForm.unitId" :items="dropdownStore.unitsOptions" item-title="text"
                item-value="value" type="text" variant="outlined" density="compact" hide-details class="tw:text-[14px]"
                rounded="lg">
                <template #label>
                  <span class="tw:text-[12px]">
            ...
            <v-col cols="12">
              <v-text-field v-model="productForm.amount" type="text" variant="outlined" density="compact" hide-details
                class="tw:text-[14px]! centred-input" rounded="lg" @keyup.enter="submitProduct">
                <template #label>
                  <span class="tw:text-[12px]">
        ...
        <v-card-actions class="tw:px-4!">
          <div class="tw:w-full tw:flex tw:justify-end tw:items-center tw:gap-1">
            ...
            <v-btn @click="submitProduct" size="" rounded="lg" class="tw:border! tw:px-0! tw:py-1! tw:w-30" :class="{
              'tw:bg-success/15! tw:text-success!  tw:border-success!':
                modalMode === 'add',
              'tw:bg-warning/15! tw:text-warning! tw:border-warning!':
                modalMode === 'edit',
