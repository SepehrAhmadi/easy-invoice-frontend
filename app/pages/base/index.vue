<template>
  <div class="tw:flex tw:flex-col tw:min-h-full">
    <!-- companies -->
    <v-container fluid class="tw:md:pe-0! tw:md:ps-4! tw:md:py-0! tw:px-7!">
      <v-row class="tw:flex tw:justify-center tw:itesm-center">
        ...
        <v-col
          ...
          sm="8"
          md="9"
          class="tw:px-0! tw:py-0! tw:lg:ps-5! tw:mt-4! tw:sm:mt-0!"
        >
          <Swiper
          ...
          >
            ...
            >
              <div
                ...
                :key="item.id"
                class="tw:bg-primary-light tw:dark:bg-background-dark tw:rounded-4xl tw:p-4! tw:sm:h-36.75 tw:m-2!"
              >
                <div
                ...
                >
                  ...
                  >
                    <component
                      ...
                      class="tw:text-[48px] tw-text-color-reverse"
                    />
                    <img
                      v-else
                  ...
                  <div class="tw:w-full! tw:flex tw:flex-col tw:gap-1">
                    ...
                    <!-- detail -->
                    <div
                      class="tw:w-full! tw:flex tw:flex-col tw:md:flex-row tw:justify-start tw:md:justify-start tw:items-start tw:md:items-center tw:gap-1 tw:md:gap-3"
                    >
                      <div
                        class="tw:flex tw:justify-start tw:items-center tw:gap-1"
                      >
